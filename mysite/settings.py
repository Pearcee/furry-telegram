...
ALLOWED_HOSTS = ['localhost','127.0.0.1', '.pythonanywhere.com','192.168.110', '192.168.1.217','p6','*']
...
INSTALLED_APPS = [
    ...
    'temprature.apps.TempratureConfig',
    'pwa',
]
...
#     }
# }
# ('host=192.168.1.113 user=postgres  dbname=test')
